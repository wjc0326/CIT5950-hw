...
void HW3Environment::AddPoints(int points) {
  ...
  cout << " (" << total_points_ << "/" << HW3_TEST_SUITE_MAXPOINTS << ")"<< endl;
}
...
void HW3Environment::SetUp() {
  cout << "HW3: there are " << HW3_TEST_SUITE_MAXPOINTS;
...
void HW3Environment::TearDown() {
  ...
  cout << HW3_TEST_SUITE_MAXPOINTS << " points available (";
  cout << ((100.0 * total_points_) / HW3_TEST_SUITE_MAXPOINTS) << "%)" << endl;
  cout << endl;
}
