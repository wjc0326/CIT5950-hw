...
void HW2Environment::AddPoints(int points) {
  ...
  cout << " (" << total_points_ << "/" << HW2_TEST_SUITE_MAXPOINTS << ")"<< endl;
}
...
void HW2Environment::SetUp() {
  cout << "HW2: there are " << HW2_TEST_SUITE_MAXPOINTS;
...
void HW2Environment::TearDown() {
  ...
  cout << HW2_TEST_SUITE_MAXPOINTS << " points available (";
  cout << ((100.0 * total_points_) / HW2_TEST_SUITE_MAXPOINTS) << "%)" << endl;
  cout << endl;
}
