...
#ifndef HW0_LINKEDLIST_H_
#define HW0_LINKEDLIST_H_
...
// Since we don't have proper objects that OOP languages like Java and C++
// have, so our interface will look slightly odd for our "object".
...
// We don't have access to templatized items like we do in C++ or Java,
...
// When we free our Deque, there may be items still in the list.
// Since we want our list to be generalizable, we need the user to specify
// how to free the elements that are still in the list, thus the
